      ...
      >
        ...
        <div className={styles.transcriptCopy}>
          <div className={styles.transcriptMeta}>
            ...
            <time>{formatTime(segment.startedAtMs)}</time>
          </div>
          <p>{segment.content}</p>
        </div>
      </div>
  ...
  return (
    <div className={styles.meetingShell}>
      ...
      <main className={styles.meetingBody}>
        ...
        <section className={styles.mapPanel} aria-label="Common ground map">
          <header className={styles.mapHeader}>
            ...
            <div className={styles.mapActions}>
              <div className={styles.modeTabs} aria-label="Map mode">
                <button
          ...
          <div className={styles.mapViewport}>
            ...
            >
              <title id="map-title">Core Product Working Group conversation map</title>
            ...
            {viewMode === "replay" && activeNodes.length === 0 && (
              <div className={styles.emptyState} aria-live="polite">
                <strong>Listening…</strong>
                <span>Press play to grow the map from the transcript.</span>
              </div>
            )}
        ...
        <aside className={styles.videoPanel} aria-label="Meeting participants">
