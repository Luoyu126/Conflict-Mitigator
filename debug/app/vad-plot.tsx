...
import { emotionNames } from "../lib/face-emotion";
import { VAD_ANCHORS, VAD_VERSION, type Vad, type VadSample } from "../lib/vad";
...
export default function VadPlot({ point, trail, status, overlayTarget = null, inline = false,
  anchors = VAD_ANCHORS, names = emotionNames, version = VAD_VERSION, source = "Face++", freshness = "采样超过 6 秒",
